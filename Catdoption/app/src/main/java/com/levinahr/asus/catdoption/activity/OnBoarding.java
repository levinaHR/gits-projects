...
import com.levinahr.asus.catdoption.Login;
import com.levinahr.asus.catdoption.R;
import com.levinahr.asus.catdoption.adapter.OnboardingSliderAdapter;
...
public class OnBoarding extends AppCompatActivity {
    ...
    private void addDots(int position) {
        ...
        if (dots.length > 0) {
            dots[position].setTextColor(getResources().getColor(R.color.pink_500));
        }
